        ...
        <div className="flex items-center gap-2 bg-white/90 dark:bg-slate-900/85 backdrop-blur-md px-3 py-1.5 rounded-2xl border border-slate-200 dark:border-slate-800 pointer-events-auto shadow-lg text-xs font-medium flex-wrap">
          ...
          {onToggleSensorsOverlay && (
            <button
              ...
              className={`p-1 px-2 2xl:px-2.5 rounded-xl transition flex items-center gap-1.5 text-[11px] font-semibold ${
                showSensorsOverlay
          ...
          {onToggleTrail && (
            ...
            >
              ...
              <span className="hidden 2xl:inline">เส้นทาง</span>
            </button>
          )}
          ...
          {onAddObstacle && (
            <div className="flex items-center gap-1 font-sans">
              <span className="text-[11px] font-bold text-amber-600 dark:text-amber-400 flex items-center gap-1">
                <Box className="w-3.5 h-3.5" /> <span className="hidden 2xl:inline">สิ่งกีดขวาง:</span>
              </span>
              <button
              ...
              >
                ...
                <span className="hidden 2xl:inline">+กล่อง</span>
              </button>
              <button
              ...
              >
                ...
                <span className="hidden 2xl:inline">+ทรงกระบอก</span>
              </button>
              <button
              ...
              >
                ...
                <span className="hidden 2xl:inline">+กำแพง</span>
              </button>
              ...
              {selectedObstacleId && onDeleteObstacle && (
                ...
                >
                  ...
                  <span className="hidden 2xl:inline">ลบที่เลือก</span>
                </button>
              )}
              ...
              {obstacles.length > 0 && onClearObstacles && (
                <button
                  ...
                  className="px-2 py-0.5 rounded-lg text-slate-500 hover:text-rose-600 dark:hover:text-rose-300 hover:bg-slate-100 dark:hover:bg-slate-800 text-[11px] font-semibold transition flex items-center gap-1"
                  title="ลบสิ่งกีดขวางทั้งหมดบนสนาม"
                >
                  <Trash2 className="w-3 h-3" />
                  <span className="hidden 2xl:inline">ล้าง</span>
                  <span className="font-mono">({obstacles.length})</span>
                </button>
              )}
            </div>
          )}
